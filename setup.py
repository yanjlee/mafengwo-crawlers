...
setuptools.setup(
    name="mafengwo-crawlers",
    version="1.2.3",
    author="yanjlee",
    author_email="yanjlee@163.com",
    description="设计这个爬虫系统的主要目的是，完整快速地获取国内所有旅游目的地和旅游景点，包括名称、介绍、图片、相关攻略等。主要使用到的技术（工具／语言／库）包括：Docker, Redis, MySQL, Python, requests, peewee等。",  # 模块简介
    install_requires=[
        'requests',
        'faker',
        'execjs',
    ...
    url="https://github.com/yanjlee/mafengwo-crawlers",  # 模块github地址
